...
public:
  ...
  const rdyn::VectorOfAffine3d& linkPose( ) const { return Tbl_; }
  const rdyn::VectorOfVector6d& linkTwist( ) const { return twist_; }
  const rdyn::VectorOfVector6d& linkTwistd( ) const { return twistd_; }
  ...
  virtual ChainStateN& operator=(const ChainStateN& rhs) = delete;
  virtual ChainStateN& operator=(ChainStateN&& rhs) = delete;
  virtual ~ChainStateN() = default;
...
protected:
  ...
  Eigen::Affine3d Tbt_;
  rdyn::VectorOfAffine3d Tbl_;
  rdyn::VectorOfVector6d twist_;
  rdyn::VectorOfVector6d twistd_;
...
{
template<int N, int MaxN = N>
std::string to_string(const rdyn::ChainStateN<N,MaxN>& chain);
}
